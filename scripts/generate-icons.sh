...
SOURCE_ICON="$ROOT_DIR/assets/brand/asciimark-icon.svg"
DESKTOP_SOURCE_ICON="$ROOT_DIR/assets/brand/asciimark-icon-bg.svg"
...
cp "$SOURCE_ICON" "$ROOT_DIR/apps/site/public/asciimark-logo.svg"
cp "$SOURCE_ICON" "$ROOT_DIR/apps/site/public/favicon.svg"
cp "$SOURCE_ICON" "$ROOT_DIR/apps/extension/public/favicon.svg"

(
  cd "$ROOT_DIR/apps/desktop"
  bunx tauri icon "../../assets/brand/asciimark-icon-bg.svg" -o "src-tauri/icons"
)
